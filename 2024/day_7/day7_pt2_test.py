    ...
    with open(file_path, 'r') as file:
        ...
        for line in file:
            ...
            if can_produce_test_value(test_value, numbers):
                ...
                print(f"Test value {test_value} can be achieved. Adding to total sum.")
                total_sum += test_value
            else:
                print(f"Test value {test_value} cannot be achieved with any combination of operators.")
                
    # Return the total sum of all achievable test values
    print(f"\nTotal calibration result: {total_sum}")
    return total_sum
